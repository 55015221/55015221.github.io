...
const loginForm = reactive({
  ...
  password: "123456",
  remember: userStore.userInfo.remember || 0,
});
...
function handleReset() {
  ...
  proxy.$refs.resetFormRef.validate((valid: any) => {
    if (valid) {
      // 这里编写业务代码
    }
  });
  ...
  <div>
    ...
    <div id="login-box">
      ...
      <el-form v-show="formType == 'login'" ref="loginFormRef" :model="loginForm" :rules="loginRules" class="login-form" autocomplete="on">
        ...
        <div>
          <el-form-item prop="email">
            <el-input ref="name" v-model="loginForm.email" placeholder="用户名" text tabindex="1" autocomplete="on">
              <template #prefix>
                <el-icon>
                  <User />
                </el-icon>
        ...
        <div style="margin-top: 20px; margin-bottom: -20px; text-align: center">
          ...
          <el-button type="primary" :loading="loading" size="small" plain @click="testemail('admin@admin.com')">admin@admin.com</el-button>
          <el-button :loading="loading" size="small" plain @click="testemail('test@admin.com')">test@admin.com</el-button>
        </div>
      </el-form>
      ...
      <el-form v-show="formType == 'register'" ref="registerFormRef" :model="registerForm" :rules="registerRules" class="login-form" auto-complete="on">
        ...
        <div>
          <el-form-item prop="email">
            <el-input ref="name" v-model="registerForm.email" placeholder="用户名" tabindex="1" autocomplete="on">
              <template #prefix>
                <el-icon>
                  <User />
                </el-icon>
      ...
      <el-form v-show="formType == 'reset'" ref="resetFormRef" :model="resetForm" :rules="resetRules" class="login-form" auto-complete="on">
        ...
        <div>
          <el-form-item prop="email">
            <el-input ref="name" v-model="resetForm.email" placeholder="用户名" tabindex="1" autocomplete="on">
              <template #prefix>
                <el-icon>
                  <User />
                </el-icon>
