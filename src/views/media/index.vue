  ...
  <div class="wrapper">
    <vxe-grid ref="gridRef" v-bind="gridOptions">
      ...
      <template #thumbnail="{ row }">
        <ImagePreview :src="row.url" :preview-src-list="[row.url]" :hide-on-click-modal="true"></ImagePreview>
      </template>
...
import ApiService from "@/api/media";
...
const gridOptions = reactive<VxeGridProps<RowVO>>({
  ...
  columns: [
    ...
    { field: "url", title: "缩略图", align: "center", width: 120, slots: { default: "thumbnail" } },
    { field: "filename", title: "名称" },
    { field: "disk", title: "存储方式" },
