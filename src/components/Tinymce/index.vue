...
const defaultSetting = ref({
  ...
  language: "zh_CN",
  skin_url: "tinymce/skins/ui/oxide", // light, oxide, oxide-dark
...
<template>
  <div id="open-source-plugins">
    <TinymceEditor v-model="tinymceContent" :init="completeSetting" :disabled="disabled" />
  </div>
</template>
