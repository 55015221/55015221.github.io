<template>
  <article class="card shadow-lg">
    ...
    <figure class="card-media">
      ...
      <swiper :modules="[Navigation, Pagination, EffectFade, A11y, Controller]" :slides-per-view="1" :space-between="20" loop autoplay navigation :pagination="{clickable: true}" @swiper="onSwiper" @slideChange="onSlideChange">
