  ...
  <div class="layout-navbars-breadcrumb-user pr15" :style="{ flex: layoutUserFlexNum }">
    <el-dropdown :show-timeout="70" :hide-timeout="50" trigger="click" @command="onComponentSizeChange">
      <div class="layout-navbars-breadcrumb-user-icon">
        <Icon name="fa fa-text-height" :title="$t('message.user.title0')" />
        <!--        <el-icon :title="$t('message.user.title0')">-->
        <!--          <SetUp />-->
        <!--        </el-icon>-->
      </div>
      <template #dropdown>
    ...
    <el-dropdown :show-timeout="70" :hide-timeout="50" trigger="click" @command="onLanguageChange">
      <div class="layout-navbars-breadcrumb-user-icon">
        <Icon name="fa fa-language" :title="$t('message.user.title1')" />
        <!--        <el-icon :title="$t('message.user.title1')">-->
        <!--          <Monitor v-if="state.disabledI18n === 'en' ? 'icon-fuhao-yingwen' : 'icon-fuhao-zhongwen'" />-->
        <!--          <Edit v-else />-->
        <!--        </el-icon>-->
      </div>
      <template #dropdown>
    ...
    <div class="layout-navbars-breadcrumb-user-icon mr10" @click="onScreenfullClick">
      ...
      <el-icon :title="state.isScreenfull ? $t('message.user.title6') : $t('message.user.title5')">
        <FullScreen v-if="!state.isScreenfull" />
        <Rank v-else />
      </el-icon>
    </div>
...
const SearchDialog = defineAsyncComponent(() => import("@/layout/navBars/topBar/search.vue"));
