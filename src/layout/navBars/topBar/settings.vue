<template>
  <div class="layout-breadcrumb-setting">
    <el-drawer :title="$t('message.layout.configTitle')" v-model="getThemeConfig.isDrawer" direction="rtl" destroy-on-close size="320px" @close="onDrawerClose">
      <el-scrollbar class="layout-breadcrumb-setting-bar">
        ...
        <div>
          ...
          <div class="layout-breadcrumb-setting-bar-flex">
            <div class="layout-breadcrumb-setting-bar-flex-label">{{ $t("message.layout.oneTitle") }}</div>
            <div class="layout-breadcrumb-setting-bar-flex-value">
              <el-color-picker v-model="getThemeConfig.primary" show-alpha :predefine="colorList" @change="onColorPickerChange"></el-color-picker>
            </div>
          </div>
        ...
        <div>
          ...
          <div class="layout-breadcrumb-setting-bar-flex">
            ...
            <div class="layout-breadcrumb-setting-bar-flex-value">
              <el-color-picker v-model="getThemeConfig.topBar" show-alpha :predefine="colorList" @change="onBgColorPickerChange('topBar')" />
            </div>
          </div>
          <div class="layout-breadcrumb-setting-bar-flex">
            <div class="layout-breadcrumb-setting-bar-flex-label">
            ...
            <div class="layout-breadcrumb-setting-bar-flex-value">
              <el-color-picker v-model="getThemeConfig.topBarColor" show-alpha :predefine="colorList" @change="onBgColorPickerChange('topBarColor')" />
            </div>
          </div>
          <div class="layout-breadcrumb-setting-bar-flex mt10">
            ...
            <div class="layout-breadcrumb-setting-bar-flex-value">
              <el-switch v-model="getThemeConfig.isTopBarColorGradual" show-alpha :predefine="colorList" @change="onTopBarGradualChange"></el-switch>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div class="layout-breadcrumb-setting-bar-flex">
            ...
            <div class="layout-breadcrumb-setting-bar-flex-value">
              <el-color-picker v-model="getThemeConfig.menuBar" show-alpha :predefine="colorList" @change="onBgColorPickerChange('menuBar')" />
            </div>
          </div>
          <!-- 菜单默认字体颜色 -->
          <div class="layout-breadcrumb-setting-bar-flex">
            ...
            <div class="layout-breadcrumb-setting-bar-flex-value">
              <el-color-picker v-model="getThemeConfig.menuBarColor" show-alpha :predefine="colorList" @change="onBgColorPickerChange('menuBarColor')" />
            </div>
          </div>
          <!-- 菜单高亮背景色 -->
          <!-- <div class="layout-breadcrumb-setting-bar-flex">
            <div class="layout-breadcrumb-setting-bar-flex-label">{{ $t("message.layout.twoMenuBarActiveColor") }}</div>
            <div class="layout-breadcrumb-setting-bar-flex-value">
        ...
        <!-- 分栏设置 -->
        <div v-show="getThemeConfig.layout === 'columns'">
          <el-divider content-position="left">
          ...
          <div class="layout-breadcrumb-setting-bar-flex">
            ...
            <div class="layout-breadcrumb-setting-bar-flex-value">
              <el-color-picker v-model="getThemeConfig.columnsMenuBar" show-alpha :predefine="colorList" @change="onBgColorPickerChange('columnsMenuBar')" />
            </div>
          </div>
          <div class="layout-breadcrumb-setting-bar-flex">
            <div class="layout-breadcrumb-setting-bar-flex-label">
            ...
            <div class="layout-breadcrumb-setting-bar-flex-value">
              <el-color-picker v-model="getThemeConfig.columnsMenuBarColor" show-alpha :predefine="colorList" @change="onBgColorPickerChange('columnsMenuBarColor')" />
            </div>
          </div>
          <div class="layout-breadcrumb-setting-bar-flex mt14">
            <div class="layout-breadcrumb-setting-bar-flex-label">
            ...
            <div class="layout-breadcrumb-setting-bar-flex-value">
              <el-switch v-model="getThemeConfig.isColumnsMenuBarColorGradual" show-alpha :predefine="colorList" @change="onColumnsMenuBarGradualChange" />
            </div>
          </div>
          <div class="layout-breadcrumb-setting-bar-flex mt14">
            <div class="layout-breadcrumb-setting-bar-flex-label">
            ...
            <div class="layout-breadcrumb-setting-bar-flex-value">
              <el-switch v-model="getThemeConfig.isColumnsMenuHoverPreload" show-alpha @change="onColumnsMenuHoverPreloadChange"></el-switch>
            </div>
          </div>
          <div class="layout-breadcrumb-setting-bar-flex mt15">
            <div class="layout-breadcrumb-setting-bar-flex-label">
            ...
            <div class="layout-breadcrumb-setting-bar-flex-value">
              <el-select v-model="getThemeConfig.columnsAsideStyle" placeholder="请选择" style="width: 90px" @change="setLocalThemeConfig">
          ...
          <div class="layout-breadcrumb-setting-bar-flex mt15 mb27">
            ...
            <div class="layout-breadcrumb-setting-bar-flex-value">
              <el-select v-model="getThemeConfig.columnsAsideLayout" placeholder="请选择" style="width: 90px" @change="setLocalThemeConfig">
        ...
        <div>
          ...
          <div class="layout-breadcrumb-setting-bar-flex" :style="{ opacity: getThemeConfig.layout === 'transverse' ? 0.5 : 1 }">
            ...
            <div class="layout-breadcrumb-setting-bar-flex-value">
              <el-switch v-model="getThemeConfig.isCollapse" :disabled="getThemeConfig.layout === 'transverse'" @change="onThemeConfigChange"></el-switch>
            </div>
          </div>
          <div class="layout-breadcrumb-setting-bar-flex mt15" :style="{ opacity: getThemeConfig.layout === 'transverse' ? 0.5 : 1 }">
            ...
            <div class="layout-breadcrumb-setting-bar-flex-value">
              <el-switch v-model="getThemeConfig.isUniqueOpened" :disabled="getThemeConfig.layout === 'transverse'" @change="setLocalThemeConfig"></el-switch>
            </div>
          </div>
          <div class="layout-breadcrumb-setting-bar-flex mt15">
            <div class="layout-breadcrumb-setting-bar-flex-label">
          ...
          <div class="layout-breadcrumb-setting-bar-flex mt15" v-show="getThemeConfig.layout === 'classic'">
            <div class="layout-breadcrumb-setting-bar-flex-label">
              {{ $t("message.layout.threeIsClassicSplitMenu") }}
            </div>
            <div class="layout-breadcrumb-setting-bar-flex-value">
              <el-switch v-model="getThemeConfig.isClassicSplitMenu" @change="onClassicSplitMenuChange"></el-switch>
            </div>
          </div>
        </div>
        ...
        <!-- Tags View  -->
        <div>
          <el-divider content-position="left"> Tagsview 设置</el-divider>
          <div class="layout-breadcrumb-setting-bar-flex mt15">
            <div class="layout-breadcrumb-setting-bar-flex-label">
          ...
          <div v-show="getThemeConfig.isTagsview">
            <div class="layout-breadcrumb-setting-bar-flex mt15">
              <div class="layout-breadcrumb-setting-bar-flex-label">
        ...
        <div>
          ...
          <div class="layout-breadcrumb-setting-bar-flex mt15" v-show="getThemeConfig.layout !== 'transverse'">
            <div class="layout-breadcrumb-setting-bar-flex-label">
        ...
        <div>
          ...
          <div class="layout-breadcrumb-setting-bar-flex mt11">
            ...
            <div class="layout-breadcrumb-setting-bar-flex-value">
              <el-input-number v-model="getThemeConfig.lockScreenTime" controls-position="right" :min="1" :max="9999" @change="setLocalThemeConfig" style="width: 90px"> </el-input-number>
            </div>
          </div>
        </div>
...
// 预定义主题颜色
const colorList = ["#009688", "#daa96e", "#0c819f", "#409eff", "#27ae60", "#ff5c93", "#e74c3c", "#fd726d", "#f39c12", "#9b59b6"];
